...
IfMsgBox, Yes
	KX  := 1892
	K1	:= 154	;功能,矩形选择,坐标,		1892,150,快捷键,ctrl+shift+f1
	K2	:= 191	;功能,套索,坐标,			1892,205,快捷键,ctrl+shift+f2
	K3	:= 225	;功能,青笔,坐标,			1894,267,快捷键,ctrl+shift+f3
	K4	:= 264	;功能,粉笔,坐标,			1894,319,快捷键,ctrl+shift+f4
	K5	:= 308	;功能,荧光笔,坐标,			1894,369,快捷键,ctrl+shift+f5
	K6	:= 335	;功能,绿色高亮,坐标,		1894,429,快捷键,ctrl+shift+f6
	K7	:= 366	;功能,黄色高亮,坐标,		1894,481,快捷键,ctrl+alt+1
	K8	:= 402	;功能,红下划线,坐标,		1894,536,快捷键,ctrl+alt+2
	K9	:= 440	;功能,字,坐标,				1894,587,快捷键,ctrl+alt+3
	K10	:= 476	;功能,红线,坐标,			1894,643,快捷键,ctrl+alt+4
	K11	:= 517	;功能,橡皮擦,坐标,			1894,689,快捷键,ctrl+alt+5
	K12	:= 554	;功能,移动,坐标,			1894,749,快捷键,ctrl+alt+6
